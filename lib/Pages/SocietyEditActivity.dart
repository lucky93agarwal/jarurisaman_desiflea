...
import 'package:delivoo/Pages/LoginEditAddressActivty.dart';
...
class SocietyEditActivity extends StatefulWidget {
  final String CityName;
  final String AreaName;
  final String Cityid;
  final String Areaid;
  SocietyEditActivity({this.CityName, this.Cityid, this.AreaName, this.Areaid});
  @override
  _SocietyEditActivityState createState() => _SocietyEditActivityState();
}
...
class _SocietyEditActivityState extends State<SocietyEditActivity> {
  ...
  addStringToSF(String society, String id) async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => LoginEditAddressActivty(CityName:cityName,Cityid:cityID, AreaName:areaName,Areaid:areaID, SocietyName:society, SocietyID:id)),
    );
  }
  ...
  _runapi() async {
    ...
    String objText = '{"cdblock": "society","id": ' + areaID + '}';
  ...
  String cityName,areaName,cityID, areaID;
  ...
  void initState() {
    ...
    print("Check Address Update Society cityName = = ="+cityName.toString());
    print("Check Address Update Society areaName = = ="+areaName.toString());
    print("Check Address Update Society cityID = = ="+cityID.toString());

    print("Check Address Update Society areaID = = ="+areaID.toString());
                            ...
                            child: new InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => AreaEditActivity(Cityid: cityID, CityName: cityName)),
                                );
                              },
                              child: Image.asset(
